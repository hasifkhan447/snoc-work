...
C {devices/lab_pin.sym} 203.75 -255 0 0 {name=l6 sig_type=std_logic lab=in}
C {devices/lab_pin.sym} 135 -198.75 1 0 {name=l2 sig_type=std_logic lab=vdd
}
C {devices/lab_pin.sym} 197.5 -235 0 0 {name=l1 sig_type=std_logic lab=vdd
}
...
C {devices/res.sym} 525 -205 0 0 {name=R1
value=100M
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 525 -157.5 0 0 {name=l9 lab=GND}
